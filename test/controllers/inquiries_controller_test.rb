...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { aptitide: @inquiry.aptitide, fly_date: @inquiry.fly_date, longitude: @inquiry.longitude, type: @inquiry.type, user_id: @inquiry.user_id } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { aptitide: @inquiry.aptitide, fly_date: @inquiry.fly_date, longitude: @inquiry.longitude, type: @inquiry.type, user_id: @inquiry.user_id } }
